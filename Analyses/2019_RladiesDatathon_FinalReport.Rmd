...
expdata <- masterapps_20190324 %>%
  ...
  group_by(adoption,animal_type) %>% summarize_at(vars(-group_cols(c("animal_type","adoption"))),sum) %>%
...
![](`r here::here("/Analyses/2_Applicants/final_analyses/report_images/ImportantVariables.png")`
