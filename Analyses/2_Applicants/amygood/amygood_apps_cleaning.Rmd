...
```{r structure, echo = T,  message = F,  warning = F}
# Structure ----
colnames(cat_apps)
nrow(cat_apps)
head(cat_apps)
...
```{r begin_cleaning, echo = T,  message = F,  warning = F}
# Cleaning up each variable ----
apps_clean <- apps
```

```{r animal_type, echo = T,  message = F,  warning = F}
...
```{r X1, echo = T,  message = F,  warning = F}
# .... apps_clean$X1 ----
str(apps_clean$X1)
...
```{r duplicates, echo = T,  message = F,  warning = F}
# Duplicates ----
all(duplicated(apps_clean) == FALSE)
```

```{r date_submitted, echo = T,  message = F,  warning = F}
...
```
```{r ideal_adoption_timeline, echo = T,  message = F,  warning = F}
...
```{r reason_for_adoption, echo = T,  message = F,  warning = F}
...
```{r children_in_home, echo = T,  message = F,  warning = F}
...
```{r all_household_agree, echo = T,  message = F,  warning = F}
...
```{r allergies, echo = T,  message = F,  warning = F}
...
```{r home_owner, echo = T,  message = F,  warning = F}
...
```{r home_pet_policy, echo = T,  message = F,  warning = F}
...
```{r experience, echo = T,  message = F,  warning = F}
...
```{r budget_monthly, echo = T,  message = F,  warning = F}
...
```{r budget_emergency, echo = T,  message = F,  warning = F}
...
```{r home_alone_avg, echo = T,  message = F,  warning = F}
...
```{r home_alone_max, echo = T,  message = F,  warning = F}
...
```{r pet_kept, echo = T,  message = F,  warning = F}
# .... apps_clean$pet_kept ----
...
```{r exercise, echo = T,  message = F,  warning = F}
# .... apps_clean$exercise ----
...
```{r return_pet, echo = T,  message = F,  warning = F}
...
```{r how_heard, echo = T,  message = F,  warning = F}
...
```{r id, echo = T,  message = F,  warning = F}
...
```{r geo_variables, echo = T,  message = F,  warning = F}
# .... apps_clean$STATEFP ----
...
```{r city, echo = T,  message = F,  warning = F}
# .... apps_clean$City ---- 
str(apps_clean$City)
...
```{r state, echo = T,  message = F,  warning = F}
# .... apps_clean$State ----
...
```{r zip, echo = T,  message = F,  warning = F}
# .... apps_clean$ZIP ----
str(apps_clean$ZIP)
...
```{r duplicates_2, echo = T,  message = F,  warning = F}
# Duplicates ----
all(duplicated(apps_clean) == FALSE)
# one duplicate:
...
```{r structure_2, echo = T,  message = F,  warning = F}
# Structure ----
colnames(apps_clean)
nrow(apps_clean)
head(apps_clean)
...
```{r write_data, echo = T,  message = F,  warning = F}
# Write cleaned data ----
