...
```{r adoption animal boxplot, message=F, warning=F}
...
```{r animal type df, message=F, warning=F}
# related table 
...
```{r adoption animal & site boxplot}
...
```{r outcome site & animal df formattable, message=F, warning=F}
...
```{r outcome site & animal heatmap, message=F, warning=F}
...
```{r checklist days boxplot outliers, message=F, warning=F}
...
<br />
```{r checklist days boxplot, message=F, warning=F}
...
```{r checklist formattable, message=F, warning=F}
...
One main takeaway is that checklist_ACCT & checklist_SPCA are often not checked off. These correspond to:
...
```{r checklist formattable animals, message=F, warning=F}
# isolate the data that is related to checklist items for adoptions
